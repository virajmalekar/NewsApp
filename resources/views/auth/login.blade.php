...
<div class="container mt-5" style="text-align: center">
    ...
    <h1 class="display-1">Welcome to News App</h1>
    <div class="omb_login">
        <h3 class="omb_authTitle">Please Login or <a href="#">Sign up to proceed</a></h3>
        <div class="row omb_row-sm-offset-3 omb_socialButtons">
            <div class="col-xs-4 col-sm-2">

            </div>
            <div class="col-xs-4 col-sm-2">
                <a href="{{ route('social.oauth', 'google') }}" class="btn btn-lg btn-block omb_btn-google">
